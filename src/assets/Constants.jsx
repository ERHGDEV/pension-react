export const salarioMinimoVigente = 248.93  //es necesario actualizarlo al cambiar año
export const uma = 108.57 //actualizar 1ero de febrero de cada año
export const edadPension = [60, 61, 62, 63, 64, '65 o más']
export const porcentajesPension = [0.75, 0.80, 0.85, 0.90, 0.95, 1.00]
export const tabuladorCuantia = [
